  ...
  const plans = [
    {
      name: "Mobile App",
      price: "Free",
      description: "Consumer mobile application for recycling and earning rewards",
      features: [
        "QR/NFC scanning for smart bins",
        "PLY & CRT token wallet",
        "NFT eco-badge collection",
        "Wayfinder maps",
        "Basic gamification",
        "Community leaderboards",
        "Android & iOS (MVP stage)"
      ],
    ...
    },
    {
      ...
      price: "$299",
      period: "per month",
      description: "Corporate ESG tracking and recycling analytics platform",
      features: [
    ...
    },
    {
      name: "Partnership",
      price: "Custom",
      description: "Enterprise partnerships for recyclers and corporates",
      features: [
        "DePIN node operations",
        "White-label solutions",
        "Custom smart bin deployment",
      ...
      <div className="max-w-7xl mx-auto space-y-16">
        <div className="text-center space-y-4 max-w-3xl mx-auto">
          ...
          <p className="text-muted-foreground text-lg">
            From individual users to enterprise partnerships - join the Polymers Network ecosystem
          </p>
        </div>
