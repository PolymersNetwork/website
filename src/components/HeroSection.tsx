  ...
  return <section className="relative w-full py-12 md:py-20 px-6 md:px-12 flex flex-col items-center justify-center overflow-hidden bg-background">
      ...
      <div className={`relative z-10 max-w-4xl text-center space-y-6 transition-all duration-700 transform ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
        ...
        <h1 className="text-4xl md:text-6xl lg:text-7xl font-medium tracking-tighter text-balance text-foreground">
          Transform Recycling into <span className="text-primary">Rewards</span> with Polymers Network
        </h1>
        
        <p className="text-lg md:text-xl text-muted-foreground max-w-2xl mx-auto text-balance">
          Gamified, blockchain-powered recycling ecosystem. Earn PLY, RECO, and CRT tokens while making a real environmental impact.
        </p>
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center pt-6 items-center">
          ...
          <Button variant="outline" className="border-border text-foreground hover:bg-accent hover:text-accent-foreground text-base h-12 px-8 transition-all duration-200 min-h-[48px] w-full sm:w-auto">
            Documentation
          </Button>
        </div>
          ...
          <div className="bg-card backdrop-blur-md w-full">
            <div className="flex items-center justify-between p-4 border-b border-border">
              <div className="flex items-center gap-4">
                ...
                <span className="text-foreground font-medium">Polymers Dashboard</span>
              </div>
            ...
            <div className="flex h-[600px] overflow-hidden">
              ...
              <div className="w-64 border-r border-border p-4 space-y-4 hidden md:block bg-card">
                ...
                <div className="space-y-2 pt-4">
                  <div className="text-xs text-muted-foreground uppercase">Features</div>
                  <div className="space-y-1">
                    <div className="flex items-center gap-3 px-3 py-2 rounded-md text-muted-foreground hover:bg-muted/50">
              ...
              <div className="flex-1 p-4 bg-background overflow-hidden">
                ...
                <div className="flex items-center justify-between mb-6 min-w-0">
                  <div className="flex items-center gap-2 flex-shrink-0">
                    <h3 className="font-medium text-foreground">Recycling Activities</h3>
